...
<body>
    <h4 class="titre text-center">Inscription d'un formateur</h4>
    <div class="container">
        <div class="row formulaire">
            <div class="col-md-12 col-md-offset-4" style="margin-top: 20px">
                <form action="{{route('formateur_inscription')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="niveau">Niveau d'expertise</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="mdp_rep" name="mdp_rep" placeholder="Encore une fois le mdp " >
                   ...
                   <a href="login"> J'ai déjà un compte: s'inscrire</a>
