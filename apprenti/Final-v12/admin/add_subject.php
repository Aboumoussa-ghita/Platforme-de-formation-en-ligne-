		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div class="block">
									...
									<a href="subjects.php"><i class="icon-arrow-left"></i> Back</a>
										...
										<div class="control-group">
											<label class="control-label" for="inputmot_de_passe">Subject Title</label>
											<div class="controls">
											<input type="text" class="span8" name="title" id="inputmot_de_passe" placeholder="Subject Title" required>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="inputmot_de_passe">Number of Units</label>
											<div class="controls">
											<input type="text" class="span1" name="unit" id="inputmot_de_passe" required>
											</div>
										</div>
											<div class="control-group">
											<label class="control-label" for="inputmot_de_passe">Semester</label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="inputmot_de_passe">Description</label>
											<div class="controls">
