       ...
       <a href="students.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Student</a>
                        ...
                        <div class="block">
							...
							?>
								...
								<form method="post">
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input name="fn"  value="<?php echo $row['prenom']; ?>"  class="input focused" id="focusedInput" type="text" placeholder = "prenom" required>
                                          </div>
                                        </div>
										
										<div class="control-group">
                                          <div class="controls">
                                            <input  name="ln"  value="<?php echo $row['nom']; ?>" class="input focused" id="focusedInput" type="text" placeholder = "nom" required>
                                          </div>
                                        </div>
	      ...
	      <?php
                            if (isset($_POST['update'])) {
								...
								mysqli_query($conn,"update student set username = '$un' , prenom ='$fn' , nom = '$ln' , class_id = '$cys' where student_id = '$get_id' ")or die(mysqli_error());
