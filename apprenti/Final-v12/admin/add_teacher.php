   <div class="row-fluid">
                            ...
                            <div class="block-content collapse in">
								...
								<!--
									...
									-->	
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" name="prenom" id="focusedInput" type="text" placeholder = "prenom">
                                          </div>
                                        </div>
										
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" name="nom" id="focusedInput" type="text" placeholder = "nom">
                                          </div>
                                        </div>
					    ...
					    <?php
                            if (isset($_POST['save'])) {
                                ...
                                mysqli_query($conn,"insert into teacher (prenom,nom,location,department_id)
								values ('$prenom','$nom','uploads/NO-IMAGE-AVAILABLE.jpg','$department_id')         
								") or die(mysqli_error()); ?>
								<script>
