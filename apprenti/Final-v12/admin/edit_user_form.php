                            ...
                            <div class="block-content collapse in">
								...
								<form method="post">
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" value="<?php echo $row['prenom']; ?>" name="prenom" id="focusedInput" type="text" placeholder = "prenom" required>
                                          </div>
                                        </div>
										
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" value="<?php echo $row['nom']; ?>"  name="nom" id="focusedInput" type="text" placeholder = "nom" required>
                                          </div>
                                        </div>
...
mysqli_query($conn,"update users set username = '$username'  , prenom = '$prenom' , nom = '$nom' where user_id = '$get_id' ")or die(mysqli_error());
