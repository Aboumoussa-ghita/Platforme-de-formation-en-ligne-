    	...
    	<div class="modal-content">
	      	...
	      	<div class="modal-body">
	        	...
	        	<div class="form-group">
	        		<input type="text" name="ID_APPRENTI" id="ID_APPRENTI" class="form-control" placeholder="Enter Your Name" />
	        	</div>
	        	<div class="form-group">
	        		<textarea name="apprenti_review" id="apprenti_review" class="form-control" placeholder="Type Review Here"></textarea>
	        	</div>
...
$(document).ready(function(){
    ...
    $('#save_review').click(function(){
        ...
        if(ID_APPRENTI == '' || apprenti_review == '')
        {
